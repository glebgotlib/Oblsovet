...
@interface FractionTableViewController ()

@end

@implementation FractionTableViewController
...
- (void)viewDidLoad {
    ...
    [_mTable delegate];
    [_mTable dataSource];
    self.navigationItem.title = NSLocalizedString(@"Fraktion", nil);
