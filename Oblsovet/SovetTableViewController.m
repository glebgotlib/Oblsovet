...
@interface SovetTableViewController ()

@end

@implementation SovetTableViewController
{
...
- (void)viewDidLoad {
    ...
    [_mTable delegate];
    [_mTable dataSource];
    self.navigationItem.title = NSLocalizedString(@"Sovet", nil);
